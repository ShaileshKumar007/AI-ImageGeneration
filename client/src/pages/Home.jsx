...
const [searchTimeout, setSearchTimeout] = useState(null);
  ...
  return (
    <section className='max-w-7x1 mx-auto'>
        <div>
            <h1 className='font-extrabold text-[black] text-[32px]'>The Community Collection</h1>
            <p className='mt-2 text-[white] text-[16px] max-w[500px]'>Browse through a collection of imaginative and visually stunning images generated by AI</p>
        </div>
